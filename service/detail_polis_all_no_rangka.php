...
$rangka_mesin=$_REQUEST['rangka_mesin'];
...
$Cout="";
		...
		$acceptance->select("where VALUEDESC like'%$rangka_mesin%' and ASTATUS='I' and TOC in('0223','0221','0202','0253','0254','0205','0224')");
		$jumlahData=$acceptance->tampil_row();

		if($jumlahData==0){
			$nopol=substr($rangka_mesin,0,14);
			$nocer=substr($rangka_mesin,15,6);		
			$acceptance->select("where POLICYNO ='$nopol' and CERTIFICATENO='$nocer' and ASTATUS='I' and TOC in('0223','0221','0202','0253','0254','0205','0224','1006','1009','1010','1012','1014','1016')");
		}
